...
class Invoice:
    ...
    def add_comment(self, comment):
        # hold on to the unmodified comment for later
...
if __name__ == '__main__':
    ...
    invoice.add_comment("Equipment will be rented until 9/16")
    invoice.add_comment("Customer concerned by fear tax. Mission Accomplished!")
    invoice_total = invoice.calculate_total(.2)
    print(invoice_total)
    invoice.print_comments()
